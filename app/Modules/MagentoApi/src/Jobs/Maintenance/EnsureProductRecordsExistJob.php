...
class EnsureProductRecordsExistJob extends UniqueJob
{
    ...
    {
        DB::statement("
            INSERT INTO modules_magento2api_products (connection_id, product_id, inventory_totals_by_warehouse_tag_id, created_at, updated_at)
            SELECT
                modules_magento2api_connections.id,
                taggables.taggable_id as product_id,
